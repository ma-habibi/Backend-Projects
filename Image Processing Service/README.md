...
A backend service for uploading, transforming, and retrieving images — similar in spirit to Cloudinary. Built as the [Image Processing Service](https://roadmap.sh/projects/image-processing-service) project from [roadmap.sh](https://roadmap.sh).
